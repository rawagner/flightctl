    ...
    spec:
      ...
      - name: setup-database-users
        ...
        - name: DB_ADMIN_USER
          valueFrom:
            secretKeyRef:
              name: {{ default "flightctl-db-admin-secret" $ctx.Values.db.masterUserSecret }}
              key: masterUser
        ...
        - name: DB_MIGRATION_USER
          valueFrom:
            secretKeyRef:
              name: {{ default "flightctl-db-migration-secret" $ctx.Values.db.migrationUserSecret }}
              key: migrationUser
        ...
        - name: DB_APP_USER
          valueFrom:
            secretKeyRef:
              name: {{ default "flightctl-db-app-secret" $ctx.Values.db.userSecret }}
              key: user
